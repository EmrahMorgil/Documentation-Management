    ...
    <div className="container">
      <table className="table table-striped">
        ...
        <thead className="thead-dark">
          <tr>
            <th scope="col">ID</th>
            <th onClick={sortByProjectName} className="pointer" scope="col">
              Project Name
              {projectSorted.sorted
                ? projectSorted.isReversed
                  ? "▲"
                  : "▼"
                : null}
            </th>
            <th onClick={sortByCreatedDate} className="pointer" scope="col">
              Created Date
            ...
            <th onClick={sortByUpdatedDate} className="pointer" scope="col">
              Updated Date
            ...
            <th onClick={sortByTotalContent} className="pointer" scope="col">
              Total Content
              {totalSorted.sorted ? (totalSorted.isReversed ? "▲" : "▼") : null}
            </th>
            <th onClick={sortByVisibilityRole} className="pointer" scope="col">
              Visibility Role
